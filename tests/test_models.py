...
class TestModels(unittest.TestCase):
    ...
    def test_all_models(self):
        test_configs = [
            ...
            {
                # K3 feature matrix: situ activation + attention residuals +
                # latent MoE, all three OFF in the kimi_linear entry above.
                # 6 layers / attn_res_block_size 2 so the summary stack is
                # built AND attended over repeatedly; with block_size == depth
                # the multi-summary path never runs.
                "model_type": "kimi_linear",
                "vocab_size": 1000,
                "hidden_size": 128,
                "num_hidden_layers": 6,
